...
export default function ChatDrawer({
                                       open, onClose, roomId, onChangeRoom, autoOpenNewChat, onRoomsChanged,scrollToMessageId
                                   }) {
        ...
        <div className="chatOverlay" onMouseDown={onClose}>
            <div className="chatDrawer" onMouseDown={(e) => e.stopPropagation()}>
                ...
                <div className="chatDrawerBody">
                    {roomId ? <ChatPanel key={roomId} roomId={roomId} scrollToMessageId={scrollToMessageId} /> : <div className="chatEmpty">대화를 선택하거나 새 채팅을 시작하세요</div>}
                </div>

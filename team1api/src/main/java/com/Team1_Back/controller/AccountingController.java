 ...
 * 
 * <p>부서별, 카테고리별 지출 통계 및 예산 관련 정보를 조회하는 기능을 제공합니다.
...
public class AccountingController {
     ...
     * 
     * <p>각 카테고리별 지출 금액과 건수를 집계하여 반환합니다.
     * 승인 상태로 필터링이 가능합니다.
     * 
     * @param status 필터링할 승인 상태 (선택)
     * @param principal 인증된 사용자 정보
     ...
     * 
     * <p>전체 지출 금액, 건수, 평균 금액 등의 요약 정보를 반환합니다.
     * 
     * @param principal 인증된 사용자 정보
     ...
     * 
     * <p>월별 예산을 초과한 사용자 목록과 초과 금액을 반환합니다.
     * 
     * @param principal 인증된 사용자 정보
     ...
     * 
     * <p>전체 통계 요약, 부서별 통계, 카테고리별 통계, 예산 초과 인원 목록을 한번에 반환합니다.
     * 
     * @param principal 인증된 사용자 정보
